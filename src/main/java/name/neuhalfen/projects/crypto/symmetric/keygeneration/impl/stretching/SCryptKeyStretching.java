...
public class SCryptKeyStretching implements KeyStretching {
    ...
    public final static class SCryptKeyStretchingParameters implements Serializable{
        ...
        /**
         * Generate a workload factor for sensitive ( ~5 seconds in 2017)
         * derivation with very weak input key material.
         *
         ...
         * derivation.
         * <p>
         * You can use this if the secret has a very high entropy but is not perfect.
         *
         ...
         * derivation.
         * <p>
         * **Only use this if your input key material is very good**
         *
         * Candidates for good key material are
         * * very long, random passwords (~22 chars for a 128 bit key)
         * * passwords generated by e.g. a password manager
         * <p>
    ...
    public byte[] strengthenKey(byte[] salt, byte[] keyToStrengthen, int desiredKeyLengthInBit) {
        ...
        final byte[] key = SCrypt.generate(keyToStrengthen, salt, cfg.getN(), cfg.getR(), cfg.getP(), desiredKeyLengthInBytes);
        return key;
    }
}
