...
/**
 * Interface that describes keyrings (e.g. pubring.gpg and secring.gpg, or any other means
 * to get a list of valid keys).
 * .
 * Custom implementations might for example get the keys from a webservice.
 *
 * @see KeyringConfigs
 */
public interface KeyringConfig {
    ...
    /**
     * The keyid passed in is the keyid of the sub-key used. E.g. for the following keyring
     * you'd expect keyID values of 0x86DAC13816FE6FE2 or 0x54A3DB374F787AB7
     * .
     ...
     * .
     * Most implementations delegate to an implementation of {@link name.neuhalfen.projects.crypto.bouncycastle.openpgp.keys.callbacks.KeyringConfigCallback}
     *
