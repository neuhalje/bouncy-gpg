...
/**
 * Takes a ZIP file, unpacks it in memory (streaming), and writes the files encrypted. . E.g. with a
 * file  /tmp/my_zip.zip  created this way: . # find . README dir_a/file1 dir_a/file2
 * dir_b/dir_b1/file3 . zip -r /tmp/my_zip.zip . . The class will unpack, an re-encrypt the
 * following directory structure . # find . README.gpg dir_a/file1.gpg dir_a/file2.gpg
 * dir_b/dir_b1/file3.gpg
 */
public final class ReencryptExplodedZipMultithreaded {

  private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory
      .getLogger(ReencryptExplodedZipMultithreaded.class);

  public void explodeAndReencrypt(final InputStream plainTextStreamOfZip,
      final ZipEntityStrategy zipEntityStrategy,
      final BuildEncryptionOutputStreamAPI.Build encryptionFactory) throws Exception {
