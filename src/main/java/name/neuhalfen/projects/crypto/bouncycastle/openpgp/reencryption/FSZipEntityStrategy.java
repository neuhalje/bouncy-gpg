...
public class FSZipEntityStrategy implements ZipEntityStrategy {
    ...
    private final static Pattern REMOVE_LEADING_RELATIVE_PATH = Pattern.compile("^(([.]{2,})|/|\\\\)*", Pattern.COMMENTS);

    private final static Pattern REMOVE_DOT_DOT_REGEXP = Pattern.compile("[.]{2,}", Pattern.COMMENTS);
    private final static Pattern REMOVE_FOLLOWING_REGEXP = Pattern.compile("[^a-zA-Z0-9_, +-./\\\\]", Pattern.COMMENTS);
