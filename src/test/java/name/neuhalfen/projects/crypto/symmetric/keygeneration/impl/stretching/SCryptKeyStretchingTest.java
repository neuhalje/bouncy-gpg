...
public class SCryptKeyStretchingTest {
  ...
  public void scrypt_isDeterministic_withTwoInstances() {
    SCryptKeyStretching.SCryptKeyStretchingParameters fastParams = SCryptKeyStretching.SCryptKeyStretchingParameters
    ...
    assertThat(sut1.strengthenKey(SALT_24BIT, testData, KEY_LEN),
        equalTo(sut2.strengthenKey(SALT_24BIT, testData, KEY_LEN)));
  ...
  public void scrypt_isDeterministic_withSameInstance() {
    ...
    assertThat(sut.strengthenKey(SALT_24BIT, testData, KEY_LEN),
        equalTo(sut.strengthenKey(SALT_24BIT, testData, KEY_LEN)));
  ...
  public void performanceTest_quick() {
    ...
    System.out.printf("%d kdfs took %dms. (%2.2fms per strengthenKey)", ROUNDS,
        timeDuration / 1000 / 1000, timeDuration / ROUNDS / 1000 / 1000.0);
  }
  ...
  public void performanceTest_slow() {
    ...
    final long timeEnd = System.nanoTime();
    final long timeDuration = timeEnd - timeStart;
    System.out.printf("%d kdfs took %ds. (%2.2fs per strengthenKey)", ROUNDS,
        timeDuration / 1000 / 1000 / 1000, timeDuration / ROUNDS / 1000 / 1000 / 1000.0);
  }
  ...
  public void performanceTest_quickest() {
    ...
    final long timeEnd = System.nanoTime();
    final long timeDuration = timeEnd - timeStart;
    System.out.printf("%d kdfs took %d ms. (%1.2fms per strengthenKey)", ROUNDS,
        timeDuration / 1000 / 1000, timeDuration / ROUNDS / 1000 / 1000.0);
  }
}