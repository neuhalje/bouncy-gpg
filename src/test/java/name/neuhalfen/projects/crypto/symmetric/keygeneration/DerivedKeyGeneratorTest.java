...
public class DerivedKeyGeneratorTest {
    ...
    @Test
    public void constructDerivedKeyIdentifier_withEmptyContext_returnsValidIdentifier() throws Exception {
        assertThat("   0::47", is(sut().constructDerivedKeyIdentifier("", "47")));
    }

    @Test
    public void constructDerivedKeyIdentifier_withColonContext_returnsValidIdentifier() throws Exception {
